  ...
  return (
    ...
    >
      <div className="text-center max-w-3xl">
        <h2 className="text-5xl font-bold mb-4">Need A Hand?</h2>
        <p className="text-lg text-gray-600">
          Whether It's Code or Conversation — Let's Get in Touch
        </p>
      </div>

      <div className="flex flex-wrap justify-center gap-10 mt-10">
        <a href="https://www.linkedin.com/in/uvindu-suraweera-03b527216/">
        ...
        <a href="https://github.com/kavi20011211">
          <div className="w-8 h-8 cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
        ...
        <a href="https://wa.me/qr/ERZO4OQYRI2AC1">
          <div className="w-8 h-8 cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              x="0px"
